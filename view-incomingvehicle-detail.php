...
$sql1 = "SELECT * FROM `tblcategory` WHERE `VehicleCat` like '$cat'";
...
$hours = $interval->h + ($interval->days * 24); // Total difference in hours
...
<table class="table mb-0"> 
                  ...
                  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <tr>
                      ...
                      <td> 
                        <input type="text" name="parkingcharge" id="parkingcharge" class="form-control"  value="<?php  echo $hours*$rate;  ?>" readonly="">
                      </td>
                    </tr>
                    <tr>
                      <th>Status :</th>
