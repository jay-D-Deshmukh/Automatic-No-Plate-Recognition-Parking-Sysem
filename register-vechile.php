...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($conn, "insert into  registered(category,company,number,owner,contact) value('$catename','$vehcomp','$vehreno','$ownername','$ownercontno')");
    if ($query) {
...
<li class="breadcrumb-item"><a>Register Vehicle</a>
</li>
<li class="breadcrumb-item"><a href="register-vehicle.php">Register Vehicle</a>
</li>
</ul>
</div>
</div>
